...
<template>
    ...
    >
        <div class="relative h-full flex">
            ...
            <!-- Chat Panel -->
            <Card
                class="h-full w-96 rounded-none rounded-l-lg border-r-0 flex flex-col shadow-2xl"
            >
                ...
                <CardContent class="flex-1 overflow-y-auto p-4">
                    <div class="space-y-2">
                        <div
                            ...
                            :key="index"
                            class="rounded px-2 py-1 flex flex-col"
                        >
