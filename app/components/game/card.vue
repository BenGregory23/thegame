...
<template>
    <div class="relative group">
        ...
        >
            ...
            <span
                class="absolute top-1 left-1.5 text-xs lg:text-sm font-bold opacity-70"
            >
                {{ value }}
            </span>
            ...
            <span
                class="absolute bottom-1 right-1.5 text-xs lg:text-sm font-bold opacity-70 rotate-180"
            >
                {{ value }}
            </span>
        ...
        >
            <Circle
                class="text-muted-foreground/40 w-6 h-6"
                :stroke-width="1.5"
            />
        </div>
