...
useSeoMeta({
    title: "The Gamo - Join room",
    ogTitle: "The Gamo - Join room",
    description: "Click on the link to join the room and start playing",
    ogDescription: "Click on the link to join the room and start playing",
    ogImage: "https://example.com/image.png",
    twitterCard: "summary_large_image",
});

function enterRoom(roomCode: string | undefined) {
    ...
    <div class="max-w-2xl mx-auto p-6 space-y-8">
        ...
        <Card class="border-2 hover:border-primary/50 transition-colors w-96">
            <CardHeader>
                ...
                <CardDescription
                    >Join an already existing room to play.</CardDescription
                >
            </CardHeader>
            <CardContent class="space-y-4">
                ...
                <Button
                    ...
                    @click="enterRoom(room as string)"
                >
                    Join Room
                </Button>
            </CardContent>
